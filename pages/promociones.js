...
const Promociones = () => {
  return (
    <Layout>
      <section className='text-gray-600 bg-gradient-to-br from-indigo-50 to-green-100   body-font'>
        <div className='container px-5 py-24 mx-auto'>
          <div className='flex flex-col text-left w-full mb-20'>
            <h1
              transition-style='in:wipe:bottom-right'
              className='mt-32 text-4xl  text-left text-gray-500 font-bold'
            >
              Nuestras Acciones Promocionales Potencias tus Productos
            </h1>
          </div>
          <div className='flex flex-wrap -m-4'>
            <div className='lg:w-3/9 sm:w-2/6 p-8'>
...
<div id="services" class="section relative pt-20 pb-8 md:pt-16 md:pb-0 bg-white animate__animated animate__zoomIn animate__slow 2s">
    <div class="container xl:max-w-6xl mx-auto px-4">
        ...
        <div class="text-center mx-auto mb-12 lg:px-20">
            <h2 class="text-2xl leading-normal mb-2 font-bold text-black">Por que Elegirnos ?</h2>
         
            <p class="text-gray-500 leading-relaxed font-light text-xl mx-auto pb-2">Tu mejor opcion  para potenciar tus productos </p>
   </div>
        ...
        <div class="flex flex-wrap flex-row -mx-4 text-center">
            <div class="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" data-wow-duration="1s" >
                ...
                <div class="py-8 px-12 mb-12 bg-gray-50 border-b border-gray-100 transform transition duration-300 ease-in-out hover:-translate-y-2">
                    ...
                    <h3 class="text-lg leading-normal mb-2 font-semibold text-black">Búsqueda Especificas</h3>
            ...
            <div class="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s" >
                ...
                <div class="py-8 px-12 mb-12 bg-gray-50 border-b border-gray-100 transform transition duration-300 ease-in-out hover:-translate-y-2">
                    ...
                    <h3 class="text-lg leading-normal mb-2 font-semibold text-black">Equipos Operativos Día y Noche</h3>
                    <p class="text-green-500">This is a wider card with supporting text below as a natural content.</p>
                </div>
